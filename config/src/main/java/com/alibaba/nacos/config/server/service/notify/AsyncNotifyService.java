...
public class AsyncNotifyService extends AbstractEventListener {
    ...
    class AsyncTask implements Runnable {
        ...
        private final Queue<NotifySingleTask> queue;
    ...
    class AsyncNotifyCallBack implements FutureCallback<HttpResponse> {
        ...
        public void completed(HttpResponse response) {
            ...
            if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                log.error("[notify-retry] target:{} dataId:{} group:{} ts:{}",
        ...
        public void cancelled() {
            ...
            log.error("[notify-exception] target:{} dataId:{} group:{} ts:{} method:{}",
        ...
        private final NotifySingleTask task;
        private final CloseableHttpAsyncClient httpClient;
    }
