...
public class ConfigServletInner {
    ...
    public String doPollingConfig(HttpServletRequest request, HttpServletResponse response, Map<String, String> clientMd5Map, int probeRequestSize)
        ...
        log.info("new content:" + newResult);
    ...
    public String doGetConfig(HttpServletRequest request, HttpServletResponse response, String dataId, String group,
        ...
        if (lockResult > 0) {
            ...
            try {
                ...
                log.warn("{}|{}|{}|{}", groupKey, requestIp, md5, TimeUtils.getCurrentTimeStr());
            ...
            log.info("[client-get] clientIp={}, {}, get data during dump", clientIp, groupKey);
