...
public class LocalDataSourceServiceImpl implements DataSourceService {
    ...
    public void init() {
        ...
        ds.setUrl("jdbc:derby:" + CoreConstants.NACOS_HOME + File.separator + DERBY_BASE_DIR + ";create=true");
    ...
    public String getCurrentDBUrl() {
        return "jdbc:derby:" + CoreConstants.NACOS_HOME + File.separator + DERBY_BASE_DIR + ";create=true";
    }
    ...
    private List<String> loadSql(String sqlFile) throws Exception {
        ...
        try {
            if (StringUtils.isBlank(System.getProperty(CoreConstants.NACOS_HOME))) {
                ClassLoader classLoader = getClass().getClassLoader();
                URL url = classLoader.getResource(sqlFile);
                sqlFileIn = url.openStream();
            } else {
                File file = new File(
                    System.getProperty(CoreConstants.NACOS_HOME) + File.separator + "conf" + File.separator + "schema.sql");
