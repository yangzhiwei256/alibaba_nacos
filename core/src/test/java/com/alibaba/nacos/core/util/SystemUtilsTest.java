...
import static com.alibaba.nacos.core.utils.CoreConstants.PREFER_HOSTNAME_OVER_IP_PROPERTY_NAME;
...
public class SystemUtilsTest {
    ...
    private static final boolean standaloneMode = random.nextBoolean();
    private static final boolean preferHostMode = random.nextBoolean();
