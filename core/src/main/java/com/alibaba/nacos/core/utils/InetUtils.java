...
import static com.alibaba.nacos.core.utils.CoreConstants.*;
...
public class InetUtils {
    ...
    private static final List<String> preferredNetworks = new ArrayList<String>();

    private static final List<String> ignoredInterfaces = new ArrayList<String>();
