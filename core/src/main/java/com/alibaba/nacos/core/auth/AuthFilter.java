...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (StringUtils.startsWith(userAgent, CoreConstants.NACOS_SERVER_HEADER)) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("access denied, request: {} {}, reason: {}", req.getMethod(), req.getRequestURI(), e.getErrMsg());
            }
