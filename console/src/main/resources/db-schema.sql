...
INSERT INTO users (username, password, enabled) VALUES ('iot-app', '$2a$10$5g5as5TCY4LX8ANLeVVYIujUSx2RRBkAXN0F/F.9E.IXWbYARZJwa', true);
INSERT INTO roles (username, role) VALUES ('iot-app', 'ROLE_APP');

-- 应用角色权限

INSERT INTO permissions (`role`,resource,`action`) values ('ROLE_APP','dev:*:*','rw'),('ROLE_APP','sit:*:*','rw');
