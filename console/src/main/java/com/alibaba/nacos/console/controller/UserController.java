...
public class UserController {
    ...
    /**
     * Get paged nacos.users
     *
     * @param pageNo   number index of page
     * @param pageSize size of page
     * @return A collection of nacos.users, empty set if no user is found
     * @since 1.2.0
     */
    @GetMapping
    @Secured(resource = NacosAuthConfig.CONSOLE_RESOURCE_NAME_PREFIX + "nacos.users", action = ActionTypes.READ)
