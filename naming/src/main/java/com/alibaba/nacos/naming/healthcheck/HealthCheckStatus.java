...
public class HealthCheckStatus {
    ...
    private static final ConcurrentMap<String, HealthCheckStatus> statusMap = new ConcurrentHashMap<>();
    ...
    private static String buildKey(Instance instance) {
        try {
            ...
            log.error("[BUILD-KEY] Exception while set rt, ip {}, error: {}", instance.toJSON(), e);
        }
