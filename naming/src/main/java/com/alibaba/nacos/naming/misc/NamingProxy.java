...
public class NamingProxy {
    ...
    public static void syncCheckSums(Map<String, String> checksumMap, String server) {
        ...
        try {
            ...
            headers.put(CommonConstants.CLIENT_VERSION_HEADER, VersionUtils.VERSION);
            headers.put(CommonConstants.USER_AGENT_HEADER, UtilsAndCommons.SERVER_VERSION);
                ...
                new AsyncCompletionHandler() {
                    ...
                    public Object onCompleted(Response response) throws Exception {
                        if (HttpURLConnection.HTTP_OK != response.getStatusCode()) {
                            log.error("failed to req API: {}, code: {}, msg: {}",
    ...
    public static String reqAPI(String api, Map<String, String> params, String curServer) throws Exception {
        try {
            List<String> headers = Arrays.asList(
                ...
                CommonConstants.USER_AGENT_HEADER, UtilsAndCommons.SERVER_VERSION,
