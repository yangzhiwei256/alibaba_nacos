...
public class ServiceManager implements RecordListener<Service> {
    ...
    public void init() {
        ...
        try {
            log.info("listen for service meta change");
            consistencyService.listen(KeyBuilder.SERVICE_META_KEY_PREFIX, this);
        } catch (NacosException e) {
            log.error("listen for service meta change failed!");
        }
    }
    ...
    public void addUpdatedService2Queue(String namespaceId, String serviceName, String serverIP, String checksum) {
        ...
        try {
            ...
            log.error("[DOMAIN-STATUS] Failed to add service to be updatd to queue.", e);
        } finally {
            lock.unlock();
        }
    }
    ...
    public void onChange(String key, Service service) throws Exception {
        try {
            ...
            log.info("[RAFT-NOTIFIER] datum is changed, key: {}, value: {}", key, service);
            ...
            log.error("[NACOS-SERVICE] error while processing service update", e);
        }
    }
    ...
    public void onDelete(String key) throws Exception {
        ...
        log.info("[RAFT-NOTIFIER] datum is deleted, key: {}", key);
        ...
        if (service != null) {
            ...
            log.info("[DEAD-SERVICE] {}", service.toJSON());
        }
            ...
            try {
                while (true) {
                    try {
                        ...
                        log.error("[UPDATE-DOMAIN] Exception while taking item from LinkedBlockingDeque.");
                    }
                ...
                log.error("[UPDATE-DOMAIN] Exception while update service: {}", serviceKey, e);
            }
        }
    }
    ...
    private class ServiceUpdater implements Runnable {
        ...
        public void run() {
            try {
                ...
                log.warn("[DOMAIN-UPDATER] Exception while update service: {} from {}, error: {}",
        ...
        if (null != otherServerSet && otherServerSet.size() > 0) {
            for (String server: otherServerSet) {
                ...
                try {
                    ...
                    log.warn("[QUERY-CLUSTER-STATE] Exception while query cluster state from {}, error: {}",
                        server, e);
                }
            }
        }
    ...
    public void updatedHealthStatus(String namespaceId, String serviceName, String serverIP) {
        ...
        if (changed && log.isDebugEnabled()) {
            log.debug("[HEALTH-STATUS-UPDATED] namespace: {}, service: {}, ips: {}",
    ...
    public void createServiceIfAbsent(String namespaceId, String serviceName, boolean local, Cluster cluster) throws NacosException {
        ...
        if (service == null) {
            ...
            log.info("creating empty service {}:{}", namespaceId, serviceName);
            service = new Service();
    ...
    private void putServiceAndInit(Service service) throws NacosException {
        ...
        log.info("[NEW-SERVICE] {}", service.toJSON());
    }
    ...
    public static class ServiceChecksum {
        ...
        public void addItem(String serviceName, String checksum) {
            if (StringUtils.isEmpty(serviceName) || StringUtils.isEmpty(checksum)) {
                log.warn("[DOMAIN-CHECKSUM] serviceName or checksum is empty,serviceName: {}, checksum: {}",
    ...
    private class ServiceReporter implements Runnable {
        ...
        public void run() {
            try {
                ...
                log.error("[DOMAIN-STATUS] Exception while sending service status", e);
            } finally {
