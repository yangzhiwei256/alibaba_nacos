...
public class LocalConfigInfoProcessor {
    ...
    static public String getFailover(String serverName, String dataId, String group, String tenant) {
        ...
        try {
            ...
            log.error("[" + serverName + "] get failover error, " + localPath, ioe);
            return null;
        }
    }
    ...
    static public String getSnapshot(String name, String dataId, String group, String tenant) {
        ...
        try {
            ...
            log.error("[" + name + "]+get snapshot error, " + file, ioe);
            return null;
        }
    }
    ...
    static public void saveSnapshot(String envName, String dataId, String group, String tenant, String config) {
        ...
        if (null == config) {
            try {
                ...
                log.error("[" + envName + "] delete snapshot error, " + file, ioe);
            }
        } else {
            try {
                ...
                if (!parentFile.exists()) {
                    ...
                    if (!isMdOk) {
                        log.error("[{}] save snapshot error", envName);
                    }
                }
                ...
                log.error("[" + envName + "] save snapshot error, " + file, ioe);
            }
        }
    }
    ...
    static {
        LOCAL_FILEROOT_PATH = System.getProperty("JM.LOG.PATH", System.getProperty("java.io.tmpdir")) + File.separator
            + "nacos" + File.separator + "config";
        LOCAL_SNAPSHOT_PATH = System.getProperty("JM.SNAPSHOT.PATH", System.getProperty("java.io.tmpdir")) + File.separator
            + "nacos" + File.separator + "config";
        log.info("LOCAL_SNAPSHOT_PATH:{}", LOCAL_SNAPSHOT_PATH);
    }
