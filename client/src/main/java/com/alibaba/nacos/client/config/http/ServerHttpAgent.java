...
public class ServerHttpAgent implements HttpAgent {
    ...
    public HttpResult httpGet(String path, List<String> headers, List<String> paramValues, String encoding, long readTimeoutMs) throws IOException {
        ...
        do {
            try {
                ...
                log.error("[NACOS ConnectException httpGet] currentServerAddr:{}, err : {}", serverListMgr.getCurrentServerAddr(), ce.getMessage());
            } catch (SocketTimeoutException stoe) {
                log.error("[NACOS SocketTimeoutException httpGet] currentServerAddr:{}， err : {}", serverListMgr.getCurrentServerAddr(), stoe.getMessage());
            } catch (IOException ioe) {
                log.error("[NACOS IOException httpGet] currentServerAddr: " + serverListMgr.getCurrentServerAddr(), ioe);
                throw ioe;
            }
    ...
    public HttpResult httpPost(String path, List<String> headers, List<String> paramValues, String encoding,
        ...
        do {
            ...
            try {
                ...
                log.error("[NACOS ConnectException httpPost] currentServerAddr: {}, err : {}", currentServerAddr, ce.getMessage());
            } catch (SocketTimeoutException stoe) {
                log.error("[NACOS SocketTimeoutException httpPost] currentServerAddr: {}， err : {}", currentServerAddr, stoe.getMessage());
            } catch (IOException ioe) {
                log.error("[NACOS IOException httpPost] currentServerAddr: " + currentServerAddr, ioe);
                throw ioe;
            }
    ...
    public HttpResult httpDelete(String path, List<String> headers, List<String> paramValues, String encoding,
        ...
        do {
            try {
                ...
                log.error("[NACOS ConnectException httpDelete] currentServerAddr:{}, err : {}", serverListMgr.getCurrentServerAddr(), ce.getMessage());
            } catch (SocketTimeoutException stoe) {
                log.error("[NACOS SocketTimeoutException httpDelete] currentServerAddr:{}， err : {}", serverListMgr.getCurrentServerAddr(), stoe.getMessage());
            } catch (IOException ioe) {
                log.error("[NACOS IOException httpDelete] currentServerAddr: " + serverListMgr.getCurrentServerAddr(), ioe);
                throw ioe;
            }
    ...
    private String getUrl(String serverAddr, String relativePath) {
        return serverListMgr.getContentPath().startsWith("/") ?
            serverAddr + serverListMgr.getContentPath() + relativePath :
            serverAddr + "/" + serverListMgr.getContentPath() + relativePath;
    }
    ...
    private static String getSTSResponse() throws IOException {
        ...
        log.error("can not get security credentials, securityCredentialsUrl: {}, responseCode: {}, response: {}",
