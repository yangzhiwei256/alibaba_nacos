...
public class EventDispatcher {
    ...
    private final ConcurrentMap<String, List<EventListener>> observerMap
    ...
    public void addListener(ServiceInfo serviceInfo, String clusters, EventListener listener) {
        ...
        log.info("[LISTENER] adding " + serviceInfo.getName() + " with " + clusters + " to listener map");
    ...
    public void removeListener(String serviceName, String clusters, EventListener listener) {
        ...
        log.info("[LISTENER] removing " + serviceName + " with " + clusters + " from listener map");
        ...
        public void run() {
            while (true) {
                ...
                try {
                    ...
                    log.error("[NA] notify error for service: "
